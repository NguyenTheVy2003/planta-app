...
import {  getCareAccessories } from '../NewHTTP';

const CareAccessorie = (props) => {
  ...
  const renderItem = ({ item }) => {
    const { _id, name, price, size, origin, image } = item;
    return (
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.txt_cayTrong}>PHỤ KIỆN CHĂM SÓC</Text>
