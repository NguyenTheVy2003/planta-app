...
const Detail_CareAccessorie = (props) => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            >
                {
                    careAccessorie.image && <Image style={styles.img_tau} source={{ uri: careAccessorie.image }}></Image>
                }
                ...
                <View style={styles.container_txt_price}>
                    ...
                    <View style={styles.container_detail_content}>
                        <View style={styles.detail_content}>
                            ...
                            <Text style={[styles.title_content,styles.title_content2]}>{careAccessorie.size}</Text>
                        </View>
                        <View style={{ width: '100%', height: 0.5, backgroundColor: '#ABABAB' }} />
                    </View>
                </View>
